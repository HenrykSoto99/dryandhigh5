...
const Auth = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Tokens already set — onAuthStateChange will redirect by role
    } catch (err: any) {
      toast({
        title: "Error con Google",
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Te enviamos un enlace seguro para restablecer tu contraseña.",
      });
    } catch (err: any) {
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground font-body">o</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailAuth} className="space-y-3">
            <div>
              ...
              <Input
                ...
                placeholder="admin@dryandhighfive.com"
                required
                className="font-body"
              />
            </div>
            <div>
              <Label htmlFor="password" className="font-body text-xs">Contraseña</Label>
              <div className="relative">
                <Input
                  id="password"
